...
def main( argv ):
    ...
    scores = sklearn.model_selection.cross_val_score(search_grid.best_estimator_, data, actual_labels, scoring="f1_micro", cv=cv, n_jobs=-1 )
    ...
    predicted_test_labels = search_grid.best_estimator_.predict_proba(test_data)
